...
function nextQuestion() {
    if (currentQuestion < totalQuestions) {
        ...
        if (currentQuestion === totalQuestions) {
            document.getElementById('https://mercadolivre3.github.io/promo/').textContent = 'Resgatar ';
        }
        ...
        window.location.href = 'https://mercadolivre3.github.io/promo/' + window.location.search;
    }
}
